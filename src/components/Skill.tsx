...
const skills = [
  ...
  { name: "shadcn/ui", icon: "https://cdn.simpleicons.org/shadcnui/61DAFB" },
  { name: "Three.js", icon: "https://cdn.simpleicons.org/three.js/61DAFB" },
  ...
  { name: "GitHub", icon: "https://cdn.simpleicons.org/github/61DAFB" },
